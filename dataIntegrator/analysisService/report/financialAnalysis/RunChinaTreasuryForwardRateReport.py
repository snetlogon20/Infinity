...
class RunChinaTreasuryForwardRateReport:
    """中国国债远期利率分析报告生成器"""

    def __init__(self):
        self.calculator = ChinaTreasuryForwardRateCalculator()
    ...
    def generate_report(self, start_date=None, end_date=None, case_name=None):
        ...
        logger.info(f"\n{'=' * 80}")
        logger.info(f" 开始生成中国国债远期利率分析报告")
    ...
    def run_batch_reports(self, report_configs):
        ...
        for idx, config in enumerate(report_configs, 1):
            ...
            self.job_logger.start_job('ChinaTreasuryForwardRateReport', 'ForwardRate',
...
if __name__ == "__main__":
    """
    使用示例 - 批量生成中国国债远期利率分析报告
    """
    import os

    runReport = RunChinaTreasuryForwardRateReport()
