...
class CMLAnalysisTest:
    ...
    def get_stock_list(self, stock_type="cn_blue_chip"):
        ...
        - stock_type: 股票类型
                      ...
                      全球指数: ['global_major', 'global_asia', 'global_europe', 'global_custom']

        返回:
        - stocks: 股票代码列表
        - market_type: 市场类型 ('US' 或 'CN' 或 'GLOBAL')
    ...
    def run_cml_analysis(self, stock_type="cn_blue_chip", start_date="20250301",
...
if __name__ == "__main__":
    ...
    cmlAnalysisTest = CMLAnalysisTest()
    ...
    for idx, config in enumerate(report_configs, 1):
        ...
        try:
            ...
            results = cmlAnalysisTest.run_cml_analysis(
