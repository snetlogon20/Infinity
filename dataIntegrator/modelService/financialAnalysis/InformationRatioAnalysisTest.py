...
本文件演示如何使用 InformationRatioAnalysis 进行纯股票投资组合分析
"""
...
class InformationRatioAnalysisTest:
    """信息比率分析测试类 - 纯股票"""

    def run_ir_analysis(self, stock_type="cn_blue_chip", start_date="20250101",
...
if __name__ == "__main__":
    """
    使用示例 - 批量生成纯股票的信息比率分析报告
    """
    irTest = InformationRatioAnalysisTest()
    ...
    for idx, config in enumerate(report_configs, 1):
        logger.info("\n" + "=" * 80)
        logger.info(f"📊 开始生成第 {idx}/{len(report_configs)} 个信息比率分析报告（纯股票）")
        ...
        try:
            ...
            results = irTest.run_ir_analysis(
